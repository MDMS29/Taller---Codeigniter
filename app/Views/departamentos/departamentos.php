<div class="container card my-4">
    ...
    <div>
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AgregarDepartamento">Agregar</button>
                ...
                <?php foreach ($datos as $x => $valor) { ?>
                    <tr>
                        ...
                        <td style="height:0.2rem;width:1rem;">
                            <input href="#" data-toggle="modal" data-target="#modal-confirma" type="image" src="<?php echo base_url(); ?>assets/img/editar.png" width="16" height="16" title="Editar Registro"></input>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <select name="pais" class="form-select" aria-label="Departamentos">
